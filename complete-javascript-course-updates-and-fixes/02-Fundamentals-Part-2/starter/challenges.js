...
let calcAverage = (n1, n2, n3) => (n1 + n2 + n3) / 3;
...
let checkWinner = function(avgDolhins, avgKoalas){
    ...
    if(avgDolhins >= avgKoalas * 2){
        ...
        console.log("We don't have a winner this time!");
    }
...
console.log(mark.bmi > john.bmi ? `${mark.fullName}'s BMI (${mark.calcBMI()}) is higher than ${john.fullName}'s (${john.calcBMI()})!` : `${john.fullName}'s BMI (${john.calcBMI()}) is higher than ${mark.fullName}'s (${mark.calcBMI()})!`);
...
console.log(calcAvrg(array1)); //100
console.log(calcAvrg(totals1)); //275.19
