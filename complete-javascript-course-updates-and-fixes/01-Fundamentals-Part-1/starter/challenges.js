...
if(dolphinsAverage > koalasAverage && dolphinsAverage >= 100){
    ...
    console.log("There is a draw! Both teams win the trophy!");
}else{
    console.log("There isn't a winner :(");
}

//BONUS 1 - The winners are the koalas!
...
//BONUS 2 - There is a draw! Both teams win the trophy!
